   ...
   <>
         <div className='row'>
          ...
          <div className='w-100 d-flex flex-wrap flex-lg-nowrap '>
            <div className='d-flex p-5 flex-item flex-column text-center align-items-center bg-info w-100 h-auto flex1' ref={flexRef1}>
              <h2>Let's Connect</h2>
              <img src='./images/what_ask.png' className='h-80 w-50' alt='myImage' ></img>
              <div className='d-flex justify-content-end contact-icon'>
                <a href='https://www.instagram.com/_dear_dharmendra/?hl=en' target='_blank' rel='noopener noreferrer'><img src='./images/insta22.png' alt='insta icon'></img></a>
                <a href='https://www.linkedin.com/in/dharmendra-prasad-sah-teli-b46340254/' target='_blank' rel='noopener noreferrer'><img src='./images/linkedin_icon.png' alt='linkedin logo'></img></a>
                <a href='https://mail.google.com/mail/?view=cm&fs=1&to=deardharmendra.2567@gmail.com' target='_blank' rel='noopener noreferrer'>
  <img src='./images/gmail1.png' alt='gmail-logo'/>
</a>

    <a href='https://www.github.com/Dharmendra2567' target='_blank' rel='noopener noreferrer'> <img src='./images/github_icon1.png' alt='github logo'></img></a>
              </div>
            ...
            <div className='flex-item  p-4 bg-info w-100  form flex2' ref={flexRef2}>
